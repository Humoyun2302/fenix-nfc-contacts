    ...
    <header className="relative px-4 pt-[max(1.75rem,env(safe-area-inset-top))]">
      <div className="page-shell relative mx-auto flex flex-col items-center text-center">
        ...
        <img
          ...
          width={130}
          height={130}
          className="animate-enter relative h-[130px] w-[130px] object-contain mix-blend-multiply"
          decoding="async"
        />

        <h1 className="animate-enter stagger-1 mt-2 text-[34px] font-semibold leading-none tracking-[-0.02em] text-ink sm:text-[36px]">
          {siteConfig.name}
        </h1>
      </div>
    </header>
