  ...
  return (
    <header className="relative px-4 pt-[max(1.5rem,env(safe-area-inset-top))]">
      <div className="page-shell relative mx-auto flex flex-col items-center text-center">
        <div className="logo-halo absolute left-1/2 top-2 h-44 w-44 -translate-x-1/2 rounded-full" />
        ...
        <img
          ...
          width={120}
          height={120}
          className="animate-enter relative h-[120px] w-[120px] object-contain mix-blend-lighten"
          decoding="async"
        />
